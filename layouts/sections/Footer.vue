    ...
    <v-container>
      ...
      ----------------------------------------------- -->
        <v-col cols="12" sm="12" md="12" lg="3" class="px-xs-0">
          ...
          <p class="mt-10">31 Binton Avenue, Greystone Park, Harare</p>
        </v-col>
        <!-- -----------------------------------------------
        Second Column
      ----------------------------------------------- -->
        <v-col cols="12" sm="12" md="12" lg="3" class="px-xs-0">
          ...
          <p class="mt-10 mb-0">+263 719 008 185</p>
      ...
      ----------------------------------------------- -->
        <v-col cols="12" sm="12" md="12" lg="3" class="px-xs-0">
          ...
          <p class="mt-10 mb-0">
            <a class="dark-link" href="/">info@zbf.co.zw</a>
          </p>
      ...
      <div class="footer-bottom-bar font-14">
        <div class="d-block d-md-flex align-center">
          <p>
            ...
            <a href="https://www.zimbohost.com/" class="link">zimbohost.com</a>
          </p>
          <div class="ml-auto">
